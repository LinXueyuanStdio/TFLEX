...
def main(data_home, temporal_data_home, dataset):
    ...
    query_args_mapping = {
        ...
        "pni": [0, 1, -1, 2, -1, 3, 4, -1], # (('e', ('r', 'r', 'n')), ('e', ('r',))) -> And(Not(Pe(Pe(e1, r1, t1), r2, t2)), Pe(e2, r3, t3))
        "pin": [0, 1, -1, 2, -1, 3, 4, -1], # (('e', ('r', 'r')), ('e', ('r', 'n'))) -> And(Pe(Pe(e1, r1, t1), r2, t2), Not(Pe(e2, r3, t3)))
        "inp": [0, 1, -1, 2, 3, -1, 4, -1], # ((('e', ('r',)), ('e', ('r', 'n'))), ('r',)) -> Pe(And(Pe(e1, r1, t1), Not(Pe(e2, r2, t2))), r3, t3)
        # npi, pni, inp
        ...
        "up": [0, 1, -1, 2, 3, -1, 4, -1], # ((('e', ('r',)), ('e', ('r',)), ('u',)), ('r',)) -> Pe(Or(Pe(e1, r1, t1), Pe(e2, r2, t2)), r3, t3)
        # 2u, up
    }
