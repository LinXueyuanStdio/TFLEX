    ...
    def embed_query(self, queries: torch.Tensor, query_structure, idx: int):
        ...
        if all_relation_flag:
            ...
            if query_structure[0] == 'e':
                ...
                logic_entity_embedding = torch.zeros_like(feature_entity_embedding)
                if self.use_cuda:
                    logic_entity_embedding = logic_entity_embedding.cuda()
...
class MyExperiment(Experiment):
    ...
    def __init__(self, output: OutputSchema, data: ComplexQueryData,
        ...
        self.store.save_scripts(["train_CQE_FLEX_IntersectionLukasiewicz.py"])
