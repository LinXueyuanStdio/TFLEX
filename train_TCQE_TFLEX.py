...
@click.option("--every_test_step", type=int, default=10000, help="test every k steps")
@click.option("--every_valid_step", type=int, default=10000, help="validation every k steps.")
