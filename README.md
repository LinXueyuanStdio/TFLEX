...
```
use_dataset(data_home="/data/TFLEX/data"); use_neural_interpreter("TFLEX_dim800_gamma15", device="cuda:1");
sample(task_name="e2i", k=1);
use_dataset(); use_neural_interpreter("TFLEX_dim800_gamma15", device="cuda:2"); sample(task_name="e2i", k=1);
emb_e1=entity_token(); emb_r1=relation_token(); emb_t1=entity_token();
emb_e2=entity_token(); emb_r2=relation_token(); emb_t2=entity_token();
