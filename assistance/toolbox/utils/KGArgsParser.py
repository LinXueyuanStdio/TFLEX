...
class KGEArgParser(ArgumentParser):
    ...
    def to_dict(self, args_dict: Dict[str, DataClass]) -> Dict[str, Dict[str, Any]]:
        """
        Helper method that serializes the dataclass instances to a dict.
        """
        data = {}
    ...
    def to_json_file(self, args_dict: Dict[str, DataClass], json_file: Union[Path, str]):
        """
        Helper method that serializes the dataclass instances to a json file.
        """
        data = self.to_dict(args_dict)
